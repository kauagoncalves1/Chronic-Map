                ...
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        <h3 class="fw-bold text-primary">
                            <i class="bi bi-person-lines-fill"></i> Criar Conta
                        </h3>
                    ...
                    <form id="formCadastro" action="cadastro_processa.php" method="POST" novalidate>
                        ...
                        <div class="d-flex gap-2 mt-3">
                            ...
                            <button type="reset" id="btnLimpar" class="btn btn-outline-secondary w-100 py-2">
                                <i class="bi bi-trash"></i> Limpar Tela
                            </button>
                        </div>
                    </form>
...
inputCep.addEventListener('blur', async () => {
    ...
    try {
        ...
        statusCep.textContent = 'Endereço não encontrado. Preencha manualmente.';
...
inputLogin.addEventListener('input', function () {
    ...
    marcarCampo(this, this.value.trim().length >= 3 && this.value.trim().length <= 30);
});
...
form.addEventListener('submit', function (event) {
    ...
    ['telefoneCelular', 'telefoneFixo'].forEach(id => {
        ...
        const digs = campo.getDigitos ? campo.getDigitos() : '';
        if (digs.length < 10) {
    ...
    if (!atualizarChecklistSenha(inputSenha.value)) {
